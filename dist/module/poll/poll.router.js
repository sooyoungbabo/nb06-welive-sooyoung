...
// 목록조회: 관리자, 입주민
pollRouter.get('/', (0, authenticate_1.default)(), (0, authorize_1.default)(client_1.UserType.ADMIN, client_1.UserType.USER), (0, validateReq_1.validateQuery)(poll_schema_1.pollListQuery, poll_schema_1.pollListQueryShape), (0, withTryCatch_1.default)(poll_control_1.default.getList));
// 상세조회: 관리자, 입주민
pollRouter.get('/:pollId', (0, authenticate_1.default)(), (0, authorize_1.default)(client_1.UserType.ADMIN, client_1.UserType.USER), (0, validateReq_1.validateParams)(poll_schema_1.pollParams), (0, withTryCatch_1.default)(poll_control_1.default.get));
// 수정: 관리자
